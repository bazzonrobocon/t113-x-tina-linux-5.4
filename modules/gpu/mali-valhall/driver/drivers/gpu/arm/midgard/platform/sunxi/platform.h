...
#define GPU_SUPPORT_DRM
#define SMC_REG_BASE 0x3000000
#define SMC_DRM_GPU_EN_OFFSET 0x54
#define SWM_DRM_HW_RST_OFFSET 0xb0
#else
#error "Need configure SMC for GPU"
#endif

//control if gpu can access drm memory
#if defined(GPU_SUPPORT_DRM)
#define SMC_GPU_DRM_REG (SMC_REG_BASE + SMC_DRM_GPU_EN_OFFSET)
#endif
...
#if defined(CONFIG_ARCH_SUN50IW9) || defined(CONFIG_ARCH_SUN55IW3)
	struct clk *bak_clk;
#endif
	struct clk *bus_clk;
