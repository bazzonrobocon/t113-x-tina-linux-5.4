...
#define SND_LOGDEV_WARN(dev, head, fmt, arg...) \
	dev_warn(dev, "[sound %4d][" head " %s] " fmt, __LINE__, __func__, ##arg)

#define SND_LOGDEV_INFO(dev, head, fmt, arg...) \
	dev_info(dev, "[sound %4d][" head " %s] " fmt, __LINE__, __func__, ##arg)

#define SND_LOGDEV_DEBUG(dev, head, fmt, arg...) \
	dev_dbg(dev, "[sound %4d][" head " %s] " fmt, __LINE__, __func__, ##arg)
