/* sound\soc\sunxi\snd_sun50iw_owa.h
...
#ifndef __SND_SUN50IW10_OWA_H
#define __SND_SUN50IW10_OWA_H
				     ...
				     unsigned int freq_out)
{
	...
	if (clk_set_rate(clk->clk_owa, freq_out)) {
		SND_LOG_ERR(HLOG, "set clk_owa rate failed, rate: %u\n", freq_out);
		return -EINVAL;
	}
