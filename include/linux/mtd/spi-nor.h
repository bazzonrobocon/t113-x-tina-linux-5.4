...
#define SR_OP_PROGRAM		 0x42
#define SR_OP_ERASE		 0x44
#define SR_OP_READ		 0x48
#define LB_OFS		 2
#define GM_UID_OP		0x5A
 ...
 * @active_stack_die:	represent current die used. 0:die0; 1:die1; 2:die2
