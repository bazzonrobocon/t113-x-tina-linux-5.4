...
#define RISCV_RST_KEY_VALUE	0x16AA0000
static SUNXI_CCU_GATE_WITH_KEY(riscv_rst_clk,  "riscv-rst",
				"dcxo24M", 0x0f20,
				RISCV_RST_KEY_VALUE,
				BIT(0), 0);

#define RISCV_KEY_VALUE	0x16AA
static SUNXI_CCU_GATE_WITH_KEY(riscv_bus_clk,  "riscv-bus",
				"dcxo24M", 0x0d04,
				RISCV_KEY_VALUE,
				BIT(31), 0);
/* ccu_des_end */
...
static struct ccu_common *sun8iw20_ccu_clks[] = {
	...
	&riscv_rst_clk.common,
	&riscv_bus_clk.common,
};
...
static struct clk_hw_onecell_data sun8iw20_hw_clks = {
	.hws	= {
		...
		[CLK_RISCV_RST]		= &riscv_rst_clk.common.hw,
		[CLK_BUS_RISCV]		= &riscv_bus_clk.common.hw,
	},
	.num = CLK_NUMBER,
};
/* ccu_def_end */
