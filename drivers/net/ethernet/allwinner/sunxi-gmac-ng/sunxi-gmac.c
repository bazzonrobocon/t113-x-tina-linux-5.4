...
#if IS_ENABLED(CONFIG_SUNXI_GMAC_NG_METADATA)
#include <linux/miscdevice.h>
#endif /* CONFIG_SUNXI_GMAC_NG_METADATA */
...
#define SUNXI_GMAC_MODULE_VERSION	"2.4.0"
...
{
	const u8 mark[4] = {0xAA, 0xAA, 0xAA, 0xAA};
	u8 *data = skb->data;

	data = data + (2 * ETH_ALEN + 2);
	return memcmp(data, mark, 4);
}
#endif
