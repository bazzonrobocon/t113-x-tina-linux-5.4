...
void awlink_asm_start(volatile void __iomem *mod_reg_addr, u32 ctrlmode, int num);
...
int awlink_asm_probe(struct device_node *node, int num);
void awlink_asm_fun0(int num, int pin_id);
void awlink_asm_fun1(int num);
void awlink_asm_fun2(int num);
void awlink_asm_fun3(int num);
void awlink_asm_fun4(int num);
void __iomem *awlink_asm_fun5(int num);
#endif
