...
#if defined CONFIG_ARCH_SUN8IW16P1 || defined CONFIG_ARCH_SUN8IW19P1 || defined CONFIG_ARCH_SUN55IW3
...
#if defined (CONFIG_ARCH_SUN50IW10P1) || defined (CONFIG_ARCH_SUN55IW3)
